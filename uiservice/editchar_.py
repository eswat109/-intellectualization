...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(200, 60, 160, 80))
        ...
        self.tableViewValues = QtWidgets.QTableView(self.tab_Enum)
        self.tableViewValues.setGeometry(QtCore.QRect(50, 70, 231, 121))
        self.tableViewValues.setObjectName("tableViewValues")
